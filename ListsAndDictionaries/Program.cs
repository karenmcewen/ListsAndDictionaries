...
namespace ListsAndDictionaries
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //.Add - adds to the end and makes list longer
            faveFoods.Add("ice cream");
            Console.WriteLine(faveFoods[5]);

            //.Remove - removes something from the list and shortens everything (everything moves over)
            ...
            //-------------------------------------------------------------------------------------
            //EXAMPLE - Luck Numbers - ADD
            List<int> luckyNums = new List<int>();//if don't know elements, use .Add - will add at end
            luckyNums.Add(13);
            luckyNums.Add(8);
            luckyNums.Add(44);
            luckyNums.Add(7);
            ...
            //-------------------------------------------------------------------------------
            //EXAMPLE Numbers - REMOVE
            List<int> numberList = new List<int>() { 21, 77, 45, 89, 32, 5, 6, 23, 98, 15, 34 };
            ...
            Dictionary<int, string> coatCheck = new Dictionary<int, string>() 
                    //no semi-colon here, put at end of {}
                    {
                        {23, "Yellow Jacket"},
                        {14, "Blue Blazer" },
                        {3, "White Trenchcoat" },
            ...
            foreach (KeyValuePair<string, int> animalType in animalsAtZoo)
            {
                ...
                else
                {
                    ...
                    if (addAnimal.ToLower() == "yes")
                    {
                        ...
                        animalsAtZoo.Add(animal, numAnimal); //RUNTIME ERROR is thrown here, not sure why
                    }
                }
            }

            //-----------------------------------------------------------
            //EXAMPLE - print out the prime numbers from x to y 
